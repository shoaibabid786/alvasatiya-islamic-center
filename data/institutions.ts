...
export const institutions: Institution[] = [
  ...
  },
  {
    ...
    summary: "A computer lab donated by Taleem o Hunar Society, where students learn basic computer, video editing, graphic designing, basic AI, and more.",
    location: "Offered through Alvasatiya's educational campuses — schedule published by Admin",
    image: "/images/institutions/it-lab-students.png",
    href: "/institutions/ths-it-lab",
    students: null,
    programs: [],
    intro: [
      "THS IT Lab was donated by Taleem o Hunar Society. It is a computer classroom for Islamic students who also want practical digital skills.",
      "The lab manages its own courses and teachers. Students learn basic computer use, video editing, graphic designing, basic AI, and further modules as the office announces them.",
    ],
    educationalPrograms: [
      { title: "Basic computer", text: "Typing, files, internet, and everyday computer use for study and lawful work." },
      { title: "Video editing", text: "Cutting, titles, and presenting video for lessons and community work." },
      { title: "Graphic designing", text: "Posters, logos, and visual design with classroom practice." },
      { title: "Basic AI", text: "Simple, lawful uses of AI tools to help with study, writing, and design." },
    ],
    facilities: [
      "Computer classroom donated and equipped with support from Taleem o Hunar Society",
      "Desktops for guided practice in computer, design, and video work",
    ],
    teachers:
      "THS IT Lab manages its course list and appointed teachers. Instructor names are published when the office confirms them.",
    activities: ["Scheduled computer classes", "Video and graphic practice", "Guided AI and digital-skills sessions"],
    gallery: [
      { src: "/images/institutions/it-lab-students.png", alt: "Islamic students learning computers with a teacher in THS IT Lab" },
    ],
    admissions: "Ask the office about current THS IT Lab groups and whether a seat is available.",
    contactNote: "Mention THS IT Lab when you contact the Center.",
  },
  {
...
export const WHAT_WE_PROVIDE: ProvisionItem[] = [
  ...
  },
  {
    ...
    text: "Computer, video editing, graphic designing, and basic AI through THS IT Lab, donated by Taleem o Hunar Society.",
    icon: "computer",
  },
  {
