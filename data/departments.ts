...
export const departments: Department[] = [
  ...
  {
    slug: "it-lab",
    name: "Alvasatiya IT Lab",
    tagline: "Computer and technology education",
    intro:
      "Alvasatiya IT Lab offers computer and technology education as part of the Center's mix of Islamic and modern learning.",
    purpose: "To give students practical digital skills for study and lawful work.",
    objectives: [
      "Teach foundational computer skills",
      "Support students already enrolled in Islamic programs",
    ],
    services: ["Computer education", "Guided practice sessions"],
    programs: ["Computer education", "Practical IT skills"],
    activities: ["Scheduled computer classes"],
    cta: { label: "View IT Lab", href: "/institutions/alvasatiya-it-lab" },
  },
  {
  ...
  },
  {
    slug: "online-courses",
    name: "Online Courses",
    tagline: "Quran and Islamic courses",
    intro:
      "Alvasatiya publishes Islamic courses in Quran, Tajweed, Hifz, Hadith, Fiqh, Arabic, and related studies. Students can browse courses and enroll through the website.",
    purpose: "To make Quran and Islamic learning available online and on site.",
    objectives: [
      "Offer Quran, Tajweed, and Hifz pathways",
      "Teach Islamic studies with qualified teachers",
      "Keep enrollment through the official courses page",
    ],
    services: ["Course catalog", "Enrollment", "Teacher-guided study"],
    programs: ["Quran", "Tajweed", "Hifz", "Islamic studies"],
