...
export const NAV: NavItem[] = [
  ...
  },
  {
    ...
    href: "/departments",
    children: [
      { label: "Farz Uloom", href: "/departments/farz-uloom" },
      { label: "Islamic Sisters", href: "/departments/islamic-sisters" },
      { label: "Jamia Tul Madina", href: "/departments/jamia-tul-madina" },
      { label: "Majlis Tarajim", href: "/departments/majlis-tarajim" },
      { label: "Madani Channel", href: "/departments/madani-channel" },
      { label: "Madrasa tul Madina", href: "/departments/madrasa-tul-madina" },
      { label: "Ahkam e Hajj", href: "/departments/ahkam-e-hajj" },
      { label: "Organizational Website", href: "/departments/organizational-website" },
      { label: "Social Media", href: "/departments/social-media" },
      { label: "Tree Plantation", href: "/departments/tree-plantation" },
      { label: "Majlis Tajiran", href: "/departments/majlis-tajiran" },
      { label: "Faizan Education Network", href: "/departments/faizan-education-network" },
      { label: "Maktaba tul Madinah", href: "/departments/maktaba-tul-madinah" },
      { label: "Dar ul Madinah", href: "/departments/dar-ul-madinah" },
      { label: "Faizan Online Academy", href: "/departments/faizan-online-academy" },
      { label: "Kanz ul Madaris", href: "/departments/kanz-ul-madaris" },
      { label: "Hajj O Umra", href: "/departments/hajj-o-umra" },
      { label: "Rohani Ilaj", href: "/departments/rohani-ilaj" },
    ],
  },
